...
public class Adivina {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <5 ; i++) {
              ...
              int numeroIngresado = Integer.parseInt(adivinar.nextLine()); // se obtiene el numero ingresado por el usuario
              ...
              if(numeroIngresado >= 0 && numeroIngresado <=100){ // se verifica que el numero ingresado este dentro del rango
                   ...
                   else { // verificacion de numero de intentos
                        if (intentos<5) {
                             ...
                             System.out.println("Lo siento, volviste a fallar y tus intentos se agotaron. El numero aleatorio era " + aleatorio + "!!"); // Confirmacion que los intentos acabaron
                        }
                   }
              }
              else {
